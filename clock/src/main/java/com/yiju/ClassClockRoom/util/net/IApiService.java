...
public interface IApiService {
     ...
     */
    @Multipart
    @POST(HttpUrl.SERVER_COMMON_API)
     ...
     */
    @Multipart
    @POST(HttpUrl.SERVER_COURSE_API)
     ...
     */
    @Multipart
    @POST(HttpUrl.SERVER_TEACHER_API)
