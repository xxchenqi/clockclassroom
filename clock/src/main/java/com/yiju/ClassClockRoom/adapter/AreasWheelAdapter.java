...
public class AreasWheelAdapter extends AbstractWheelTextAdapter {
	private String[] datas;

	private int currentIndex;

	public AreasWheelAdapter(Context context) {
		super(context);
	}

	public AreasWheelAdapter(Context context, String[] datas) {
