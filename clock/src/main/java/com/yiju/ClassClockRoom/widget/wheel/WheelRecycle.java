...
public class WheelRecycle {
     ...
     */
    public WheelRecycle(View wheel) {
        this.wheel = wheel;
    }
    ...
    private void recycleView(View view, int index) {
        ...
        if (wheel instanceof WheelView) {
            count = ((WheelView) wheel).getViewAdapter().getItemsCount();
            isCyclic = ((WheelView) wheel).isCyclic();
        } else {
            count = ((HorizontalWheelView) wheel).getViewAdapter().getItemsCount();
            isCyclic = ((HorizontalWheelView) wheel).isCyclic();
        }
